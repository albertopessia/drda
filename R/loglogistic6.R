...
init.loglogistic6 <- function(object) {
  ...
  param_set <- matrix(
    c(
      -0.4521, -14.8242, 0.3443, -1.3326, -3.8785, 4.26, -0.0538, 1.1476,
      -3.1888, -8.4104, 1.904, 0.419, -5.9856, -16.6958, 0.9613, -0.3481,
      -8.3553, -1.4436, 1.5947, -1.9857, -6.1151, -4.0416, -0.4099, 1.4954,
      -1.3203, 16.5142, -1.9734, -0.8755, 1.6581, 1.2953, -0.9002, 0.3867,
      1.7268, 12.5047, 0.5134, -0.578, -9.7705, 11.9881, -1.5569, 1.7326
    ),
    nrow = 4
  )
