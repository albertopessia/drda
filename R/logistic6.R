...
init.logistic6 <- function(object) {
  ...
  param_set <- matrix(
    c(
      ...
      0.02,
      # log_xi
      -0.21, 0.92, -1.47, 1.6, -2.19, 1.43, -0.96, -0.33, 2.18, 0.83, 0.26,
      0.51, 0.7, 1.06, -2.24, 1.75, 0.92, -0.79, 1.99, -0.17, 1.07, -1.72, 0.35,
      -1.84, -2.08, -1.61, -0.52, -0.69, -0.41, -1.58, 1.44, -0.36, -0.52, 0.76,
      1.01, 1.93, -0.71, -1.69, -1.05, -0.25, 1.15, 1.3, 1.11, 0.47, 1.28,
      -1.18, 0.39, -0.23, 2.15, 1.08, -0.84, -2.28, 1.62, 0.24, -2.21, 1.76,
      -1.16, 0.21, -0.66, -0.73, -0.17, 2, 1.63, -0.65, 0.41, -1.54, -1.4,
      -0.12, -0.34, -0.01, 1.51, 1.45, -1.07, 1.52, -1.46, -1.05, -0.84, -1.07,
      -2.26, -1.25, -0.06, 0.4, -1.14, 1.07, -0.99, -1.37, -1.89, -0.94, -1.9,
      1.97, -1.98, 2.15, -1.12, -0.47, 0.84, -1.51, 1.79, 0.9, -0.19, 0.39,
      1.25, -1.7, 1.67, 0.44, -0.49, -0.56, 0.9, -0.63, 0.09, -1.58, -1.14,
      0.47, 0.91, 1.58, 1.82, -0.93, 0.16, -0.32, 1.72, 1.28, -1.63, 0.14, 1.13,
      0.74, -1.44, 0.07, -0.37, 0, -0.63, 1.22, -1.66, -0.08, -1.31, 0.16,
      -2.26, 0.7, 1.84, 0.5, 1.9, -0.92, -2.21, -0.22, -0.18, -2.19, 2.11, -1.5,
      1.12, -0.65, 0.81, 1.67, 1.47, -1.6, 0.17, -0.04, 1.66, 0.18, 1.33, -1.96,
      0.65, 1.85, -0.14, -0.87, 0.01, 0.58, 0.92, 1.55, -1.11, -2.18, 0.72,
      1.37, 0.67, 0.02, -0.32, 2.16, -1.2, -1.21, 1.9, 2.3, -1.23, 0.56, -0.14,
      -0.48, 0.68, -0.44, 0.48, -1.9, -0.15, -1.35, 0.77, 0.42, -0.4, 2.18,
      1.07, 2.23, 1.33, 1.06, -0.54, -0.28, 0.18, 0.72, -1.19, -0.3, 1.3, 2.25,
      0.36, -0.93, -0.7, -2.18, 1.94, 1.43, -1.33, 0.12, 2.26, 0.63, 0.9, -0.63,
      -1.33, -1.77, 0.86, 1.21, -1.33, -0.66, -0.94, 0.81, -0.57, 1.49, 0.19,
      0.05, 0.65, -1.15, 1.66, -2.02, 0.38, -0.28, -0.48, 0.27, -1.87, -0.9,
      -0.52, 0.53, 1.46, -0.95, 1.91, 0.25, -0.96, 0.32, -1.87, 1.23, 1.87,
      -0.77
    ),
    ncol = v, byrow = TRUE
  )
...
inverse_fn.logistic6_fit <- function(object, y) {
  ...
  x <- (delta / (y - alpha))^nu
  x[x > xi] <- phi - log((x[x > xi] - xi) / nu) / eta
...
#' @export
effective_dose.logistic6_fit <- function(
